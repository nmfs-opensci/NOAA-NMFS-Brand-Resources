...
date: last-modified
brand: _extensions/nmfs-slides/_extensions/nmfs-opensci/nmfs-brand/slides_dark_brand.yml
format:
  nmfs-slides-revealjs: 
    title-slide-attributes:
      data-background-image: "_extensions/nmfs-slides/styles/horiz-swoop-1.png"
...
institute: NMFS Open Science
date: last-modified
brand: _extensions/nmfs-slides/_extensions/nmfs-opensci/nmfs-brand/slides_light_brand.yml
```
...
format:
  nmfs-slides-revealjs: 
      title-slide-attributes:
        data-background-image: "_extensions/nmfs-slides/styles/horiz-swoop-1.png, images/background.jpg"
        data-background-color: '{{{< brand color dark-blue >}}}'
```
...
::: {layout-ncol="2"}
![`brand: _extensions/nmfs-slides/_extensions/nmfs-opensci/nmfs-brand/slides_light_brand.yml`](images/paste-3.png)

![`brand: _extensions/nmfs-slides/_extensions/nmfs-opensci/nmfs-brand/slides_dark_brand.yml`](images/paste-2.png)
:::
...
::: {layout-ncol="2"}
![Horizontal (`styles/horiz-swoop.png`)](images/paste-10.png){fig-align="left" width="90%"}

![Vertical (`styles/horiz-swoop.png`)](images/paste-11.png){fig-align="left" width="90%"}
:::
...
::: {layout-ncol="2"}
![`{{{< brand color dark-blue >}}}`](images/paste-16.png){fig-align="left" width="85%"}

![`{{{< brand color fisheries-teal >}}}`](images/paste-15.png){fig-align="left" width="85%"}
:::
...
::: callout-note
Brand color names currently are not supported in slide attributes. Reference [\_brand.yml](_brand.yml) for brand color hex codes.
:::
